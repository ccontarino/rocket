...
function LaunchDetails(launch) {
    ...
    const addTofavorite = (launch) =>{
        localStorage.setItem('lauch', launch);
    }
    ...
    return (
        <Grid container onClick={addTofavorite} style={style.launchDetailContainer}>
            ...
            <Grid xs={12}>
                ...
                <div>description of a rocket</div>
            </Grid>
        </Grid>
    )
}
